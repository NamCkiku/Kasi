...
internal sealed class KasiLoggingScopeHttpMessageHandler : DelegatingHandler
{
    private readonly ILogger _logger;
    private readonly HashSet<string> _maskedRequestUrlParts;
    private readonly string _maskTemplate;

    public KasiLoggingScopeHttpMessageHandler(ILogger logger, HttpClientOptions options)
    {
