...
using Kasi_Server.Common.Jaeger.Builders;
using Kasi_Server.Common.Jaeger.Jaeger.RabbitMQ;
using Kasi_Server.Common.Jaeger.Tracers;
using Kasi_Server.MessageBrokers.RabbitMQ;
...
namespace Kasi_Server.Common.Jaeger;
...
public static class Extensions
{
    ...
    public static IKasi_ServerBuilder AddJaeger(this IKasi_ServerBuilder builder, string sectionName = SectionName,
    ...
    public static IKasi_ServerBuilder AddJaeger(this IKasi_ServerBuilder builder,
    ...
    public static IKasi_ServerBuilder AddJaeger(this IKasi_ServerBuilder builder, JaegerOptions options,
        string sectionName = SectionName, Action<IOpenTracingBuilder> openTracingBuilder = null)
    {
        ...
        if (!options.Enabled)
        {
            var defaultTracer = Kasi_DefaultTracer.Create();
