...
public static class Extensions
{
    ...
    public static IKasi_ServerBuilder AddKasi_Server(this IServiceCollection services, string sectionName = SectionName,
        IConfiguration configuration = null)
    {
        ...
        var builder = Kasi_ServerBuilder.Create(services, configuration);
    ...
    public static IApplicationBuilder UseKasi_Server(this IApplicationBuilder app)
    {
    ...
    public static TModel GetOptions<TModel>(this IKasi_ServerBuilder builder, string settingsSectionName)
        where TModel : new()
    {
