...
using Kasi_Server.AppMetrics.Builders;
...
namespace Kasi_Server.AppMetrics;
...
public static class Extensions
{
    ...
    public static IKasi_ServerBuilder AddMetrics(this IKasi_ServerBuilder builder,
    ...
    public static IKasi_ServerBuilder AddMetrics(this IKasi_ServerBuilder builder, MetricsOptions metricsOptions,
