using Kasi_Server.MessageBrokers.RabbitMQ.Clients;
using Kasi_Server.MessageBrokers.RabbitMQ.Contexts;
using Kasi_Server.MessageBrokers.RabbitMQ.Conventions;
using Kasi_Server.MessageBrokers.RabbitMQ.Initializers;
using Kasi_Server.MessageBrokers.RabbitMQ.Internals;
using Kasi_Server.MessageBrokers.RabbitMQ.Plugins;
using Kasi_Server.MessageBrokers.RabbitMQ.Publishers;
using Kasi_Server.MessageBrokers.RabbitMQ.Serializers;
...
public static class Extensions
{
    ...
    public static IKasi_ServerBuilder AddRabbitMq(this IKasi_ServerBuilder builder, string sectionName = SectionName,
    ...
    public static IKasi_ServerBuilder AddExceptionToMessageMapper<T>(this IKasi_ServerBuilder builder)
    ...
    public static IKasi_ServerBuilder AddExceptionToFailedMessageMapper<T>(this IKasi_ServerBuilder builder)
