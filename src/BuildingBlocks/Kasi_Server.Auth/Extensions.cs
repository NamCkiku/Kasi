using Kasi_Server.Auth.Handlers;
using Kasi_Server.Auth.Services;
...
public static class Extensions
{
    ...
    public static IKasi_ServerBuilder AddJwt(this IKasi_ServerBuilder builder, string sectionName = SectionName,
    ...
    private static IKasi_ServerBuilder AddJwt(this IKasi_ServerBuilder builder, JwtOptions options,
        Action<JwtBearerOptions> optionsFactory = null)
    {
    ...
    public static IKasi_ServerBuilder AddDistributedAccessTokenValidator(this IKasi_ServerBuilder builder)
    {
        if (!builder.TryRegister(RegistryName))
        {
            return builder;
